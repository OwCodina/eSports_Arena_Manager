package com.esports.msvc_game.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/juegos/**", "/api/v2/juegos/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers("/api/v1/juegos/**", "/api/v2/juegos/**").hasRole("ADMINISTRADOR")
