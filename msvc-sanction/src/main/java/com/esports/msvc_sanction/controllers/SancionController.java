...
public class SancionController {
    ...
    @GetMapping
    public ResponseEntity<List<SancionResponseDTO>> findAll(@RequestParam(required=false) Long usuarioId, @RequestParam(required=false) Long equipoId, @RequestParam(required=false) String estado) {
        if (usuarioId != null)
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SancionResponseDTO> findById(@PathVariable Long id) {
        return ResponseEntity.ok(sancionService.findById(id));
    }

    @GetMapping("/usuario/{usuarioId}/tiene-activa")
    public ResponseEntity<Map<String,Boolean>> tieneUsuario(@PathVariable Long usuarioId) {
    ...
    public ResponseEntity<Map<String,Boolean>> tieneEquipo(@PathVariable Long equipoId) {
        return ResponseEntity.ok(Map.of("tieneSancionActiva",
    ...
    @PutMapping("/{id}") public ResponseEntity<SancionResponseDTO> update(@PathVariable Long id, @RequestBody SancionRequestDTO dto) {
