package com.esports.msvc_team.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/equipos/**", "/api/v2/equipos/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers(HttpMethod.POST, "/api/v1/equipos/**", "/api/v2/equipos/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers("/api/v1/equipos/**", "/api/v2/equipos/**")
