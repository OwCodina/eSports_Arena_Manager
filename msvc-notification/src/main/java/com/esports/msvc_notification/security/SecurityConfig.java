package com.esports.msvc_notification.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/notificaciones/**", "/api/v2/notificaciones/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/notificaciones/**", "/api/v2/notificaciones/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers("/api/v1/notificaciones/**", "/api/v2/notificaciones/**")
