package com.esports.msvc_result.security;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/resultados/**", "/api/v2/resultados/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers(HttpMethod.POST, "/api/v1/resultados/**", "/api/v2/resultados/**")
                        .hasAnyRole("ADMINISTRADOR", "ORGANIZADOR", "JUGADOR")
                        .requestMatchers("/api/v1/resultados/**", "/api/v2/resultados/**")
